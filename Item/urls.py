...
urlpatterns = [
    ...
    path('accounts/profile/setting/add-phone',AddPhoneView.as_view(), name='add_phone'),
    path('accounts/profile/setting/deactivate-user',DeactivateUserView.as_view(), name='deactivate_user'),
    path('accounts/profile/setting/personal-details',PersomalDetailsView.as_view(), name='personal_details'),
